var containsIgnoredHashtags = (text) => {
...
var displayTwitterStatus = (status) => {
...
$.getJSON('//encosia-latest-tweet.azurewebsites.net?callback=?', (response) => {
